...
FILM_PRESETS = {
    ...
    "Kodak Portra 800 (High-ISO Color Negative)": {
        "noise_type": "gaussian",
        "channel_mode": "color",
        "base_grain_size": 1.75,
        "base_jitter": 0.0022,
        "base_aberration": 0.0014,
        "tone_warmth": 0.018,
        "noise_level": 0.042,
        "gamma_shift": 0.97,
        "edge_softening": 0.12,
    ...
    "Fuji Superia X-TRA 400 (Vibrant Everyday Color)": {
        "noise_type": "gaussian",
        "channel_mode": "color",
        "base_grain_size": 1.45,
        "base_jitter": 0.0016,
    ...
    "CineStill 400D (Daylight Cinema Halation)": {
        "noise_type": "poisson",
        "channel_mode": "color",
        "base_grain_size": 1.35,
        "base_jitter": 0.0016,
    ...
    "Kodak Pro Image 100 (Warm Tropical Color)": {
        "noise_type": "gaussian",
        "channel_mode": "color",
        "base_grain_size": 1.15,
        "base_jitter": 0.0012,
        "base_aberration": 0.0009,
        "tone_warmth": 0.020,
        "noise_level": 0.016,
        "gamma_shift": 0.98,
        "edge_softening": 0.08,
    ...
    "Fomapan 400 (Classic Czech B&W Halide)": {
        "noise_type": "laplacian",
        "channel_mode": "monochromatic",
        "base_grain_size": 1.70,
        "base_jitter": 0.0022,
    ...
    "Rollei Retro 80S (Infrared Near-IR B&W)": {
        "noise_type": "laplacian",
        "channel_mode": "monochromatic",
        "base_grain_size": 0.90,
        "base_jitter": 0.0010,
    ...
    "ADOX CHS 100 II (Classic German B&W Emulsion)": {
        "noise_type": "laplacian",
        "channel_mode": "monochromatic",
        "base_grain_size": 1.10,
        "base_jitter": 0.0012,
        "base_aberration": 0.0,
        "tone_warmth": 0.0,
        "noise_level": 0.016,
    ...
    "Lomography Potsdam Kino 100 (Cine B&W Emulsion)": {
        "noise_type": "poisson",
        "channel_mode": "monochromatic",
        "base_grain_size": 1.05,
        "base_jitter": 0.0011,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "AfterDarkStochasticNoise": "AfterDark Film Grain & Emulsion"
}
